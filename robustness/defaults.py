...
PGD_ARGS = [
    ...
    # ['spatial-constraint', [30, 40, 45], '30 deg rots/~11% translations or 40 deg rots/~14% translations', REQ],
    ...
    ['hue', float , '(recommanded pi/4) hue', REQ],
    ...
    ['transform-type', ['spatial', 'color', 'blur'], 'spatial functional perturbation if spatial, color functional perturbation if spatial,  blurring otherwise', REQ]
